...
export const dummyTestimonial = [
  {
    ...
    image: assets.mote, // replace with correct asset
    rating: 4.9,
    feedback:
  ...
  },
  {
    ...
    rating: 5,
    feedback:
      "This platform has been a game-changer for my learning journey. The interactive courses and smooth experience boosted my skills in React and Node.js.",
  },
  {
    name: "Saeed Ansari",
    role: "Professional Educator",
    image: assets.nalli, // replace with correct asset
    rating: 4.8,
    feedback:
      "As an educator, I found Edemy LMS very effective for delivering structured lessons and engaging with students seamlessly.",
  },
];
