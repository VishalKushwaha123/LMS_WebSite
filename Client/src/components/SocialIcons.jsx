...
const SocialIcons = () => {
  return (
    <div className="flex items-center gap-3 mt-5 ml-1 mb-2 max-md:mt-4">
      <Link
        target="_blank"
        to="https://www.instagram.com/mohd_shabbir_ansari/?igsh=MWsxcmVrMXJwOGN6Nw%3D%3D#"
...
"
      ...
      <Link
        target="_blank"
        to="https://github.com/Shabbir421"
      ...
      <Link
        target="_blank"
        to="https://github.com/Shabbir421/LMS_Website"
      ...
      <Link
        target="_blank"
        to="https://wa.me/918577968150?text=Hey%20%F0%9F%91%8B%2C%20how%20can%20I%20help%20you%3F"
